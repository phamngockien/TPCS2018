...
#include "test_vec_functions.hpp"

//main function try to test 4 functions via the test function called run_all_tests
int main() {
    //call run_all_tests function to produce the all tasks
    run_all_tests();
}